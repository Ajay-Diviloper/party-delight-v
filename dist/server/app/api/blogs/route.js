(()=>{var e={};e.id=49,e.ids=[49],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4464:(e,t,a)=>{"use strict";a.d(t,{f_:()=>n,lo:()=>s,uV:()=>o,vB:()=>i});let r=[{id:1,title:"The Art of Perfect Cupcake Decoration",excerpt:"Discover the secrets behind creating stunning cupcake decorations that will wow your guests at any celebration.",content:`
    ...
    `,image:"/images/cake.jpg",author:"Sarah Johnson",publishDate:"2024-01-15",category:"Baking Tips",slug:"art-of-perfect-cupcake-decoration",readTime:"5 min read",tags:["cupcakes","decoration","baking tips","desserts"],isFeatured:!0},{id:2,title:"Seasonal Baking: Spring Desserts to Brighten Your Day",excerpt:"Explore delightful spring-inspired desserts that capture the essence of the season with fresh flavors and vibrant colors.",content:`
    ...
    `,image:"/images/croissant.jpg",author:"Michael Chen",publishDate:"2024-01-10",category:"Seasonal Baking",slug:"seasonal-baking-spring-desserts",readTime:"4 min read",tags:["spring","seasonal","desserts","fresh flavors"],isFeatured:!0},{id:3,title:"The Science Behind Perfect Pastry Dough",excerpt:"Understanding the chemistry and techniques behind creating flaky, tender pastry dough that melts in your mouth.",content:`
    ...
    `,image:"/images/muffin.jpg",author:"Emily Rodriguez",publishDate:"2024-01-05",category:"Baking Science",slug:"science-behind-perfect-pastry-dough",readTime:"6 min read",tags:["pastry","baking science","dough","techniques"],isFeatured:!1},{id:4,title:"Celebration Cakes: From Simple to Spectacular",excerpt:"Learn how to create stunning celebration cakes that will make any special occasion memorable and delicious.",content:`
    ...
    `,image:"/images/bg1.jpg",author:"David Thompson",publishDate:"2023-12-28",category:"Celebration Baking",slug:"celebration-cakes-simple-to-spectacular",readTime:"7 min read",tags:["celebration cakes","decorating","special occasions","baking"],isFeatured:!1},{id:5,title:"Healthy Baking: Delicious Alternatives for Dietary Restrictions",excerpt:"Discover how to create delicious baked goods that accommodate various dietary needs without compromising on taste or texture.",content:`
    ...
    `,image:"/images/bg2.jpg",author:"Lisa Wang",publishDate:"2023-12-20",category:"Healthy Baking",slug:"healthy-baking-dietary-alternatives",readTime:"5 min read",tags:["healthy baking","dietary restrictions","gluten-free","vegan"],isFeatured:!1},{id:6,title:"The History and Evolution of French Pastries",excerpt:"Take a journey through time to explore the rich history and evolution of French pastry making, from medieval times to modern innovations.",content:`
      ...
      <p>The 18th and 19th centuries marked the golden age of French pastry, with the development of classic techniques and the creation of iconic pastries like croissants and \xe9clairs.</p>
    ...
    `,image:"/images/bg3.jpg",author:"Pierre Dubois",publishDate:"2023-12-15",category:"Baking History",slug:"history-evolution-french-pastries",readTime:"8 min read",tags:["French pastry","history","baking traditions","culinary arts"],isFeatured:!1}];function n(){return r}function s(e){return r.find(t=>t.slug===e)}function i(e){return r.filter(t=>t.category.toLowerCase()===e.toLowerCase())}function o(e){let t=e.toLowerCase();return r.filter(e=>e.title.toLowerCase().includes(t)||e.excerpt.toLowerCase().includes(t)||e.content.toLowerCase().includes(t)||e.category.toLowerCase().includes(t)||e.tags.some(e=>e.toLowerCase().includes(t)))}},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5202:(e,t,a)=>{"use strict";a.r(t),a.d(t,{patchFetch:()=>m,routeModule:()=>d,serverHooks:()=>g,workAsyncStorage:()=>p,workUnitAsyncStorage:()=>u});var r={};a.r(r),a.d(r,{GET:()=>l,OPTIONS:()=>h});var n=a(6559),s=a(8088),i=a(7719),o=a(2190),c=a(4464);async function l(e){try{let{searchParams:t}=new URL(e.url),a=t.get("slug"),r=t.get("category"),n=t.get("search"),s={"Access-Control-Allow-Origin":"*","Access-Control-Allow-Methods":"GET","Access-Control-Allow-Headers":"Content-Type"};if(a){let e=(0,c.lo)(a);if(e)return o.NextResponse.json(e,{headers:s});return o.NextResponse.json({message:"Blog not found"},{status:404,headers:s})}if(r&&"All"!==r){let e=(0,c.vB)(r);return o.NextResponse.json(e,{headers:s})}if(n){let e=(0,c.uV)(n);return o.NextResponse.json(e,{headers:s})}else{let e=(0,c.f_)();return o.NextResponse.json(e,{headers:s})}}catch(e){return console.error("API Error:",e),o.NextResponse.json({message:"Internal server error"},{status:500})}}async function h(){return new o.NextResponse(null,{status:200,headers:{"Access-Control-Allow-Origin":"*","Access-Control-Allow-Methods":"GET","Access-Control-Allow-Headers":"Content-Type"}})}let d=new n.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/blogs/route",pathname:"/api/blogs",filename:"route",bundlePath:"app/api/blogs/route"},resolvedPagePath:"D:\\party-delight-V\\party-delight\\src\\app\\api\\blogs\\route.ts",nextConfigOutput:"",userland:r}),{workAsyncStorage:p,workUnitAsyncStorage:u,serverHooks:g}=d;function m(){return(0,i.patchFetch)({workAsyncStorage:p,workUnitAsyncStorage:u})}},6487:()=>{},8335:()=>{},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),r=t.X(0,[447,580],()=>a(5202));module.exports=r})();